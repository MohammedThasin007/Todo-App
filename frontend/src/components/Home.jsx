...
function Home() {
  ...
  return (
    <div className="my-10 bg-purple-200 max-w-lg lg:max-w-xl rounded-lg shadow-lg mx-8 sm:mx-auto p-6">
      <h1 className="text-2xl font-semibold text-center">Classic Todo App</h1>
      ...
      {loading ? (
        ...
        <ul className="space-y-2">
          {todos.map((todo, index) => (
            <li
              key={todo._id || index}
              className="flex items-center justify-between p-3 bg-purple-100 rounded-md"
            >
              ...
              <button
                ...
                className="text-red-500 hover:text-red-800 duration-300 cursor-pointer"
              >
                Delete
              </button>
            </li>
      ...
      <button
        onClick={() => logout()}
        className="mt-6 px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-800 duration-500 mx-auto cursor-pointer block"
      >
        Logout
      </button>
    </div>
